    ...
    return (
      ...
      >
        <div
          data-sidebar="sidebar"
          className={cn(
            "flex h-full w-full flex-col bg-sidebar transition-[padding] duration-1000 [transition-timing-function:var(--ease-smooth)]",
...
>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        "relative flex w-full flex-1 flex-col bg-background transition-all duration-1000 [transition-timing-function:var(--ease-smooth)]",
